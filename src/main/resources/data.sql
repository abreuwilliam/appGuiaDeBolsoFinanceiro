...
INSERT INTO transaction (id, description, amount, type, date, source_account_id, destination_account_id, credit_card_id)
VALUES (random_uuid(), 'Transferência para Investimento', 500.00, 'TRANSFER', CURRENT_DATE,
        '22222222-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333', NULL);

INSERT INTO transaction (id, description, amount, type, date, source_account_id, destination_account_id, credit_card_id)
VALUES (random_uuid(), 'Pagamento Fatura Nubank', 2000.00, 'INVOICE_PAYMENT', CURRENT_DATE,
        '22222222-2222-2222-2222-222222222222', NULL, '44444444-4444-4444-4444-444444444444');

INSERT INTO transaction (id, description, amount, type, date, source_account_id, destination_account_id, credit_card_id)
VALUES (random_uuid(), 'Jantar Restaurante Japonês', 150.00, 'CREDIT_CARD_PURCHASE', CURRENT_DATE,
